...
// section and performs full validation of all those sections. The client must
// then decode the code section itself, reusing ValidateFunctionBody if
// necessary, and finally call DecodeModuleTail to decode all remaining sections
// after the code section (again, performing full validation).
